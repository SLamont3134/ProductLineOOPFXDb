...
public class ProductionRecord {
     ...
     * @throws IllegalProductArgumentException thrown if illegal parameter.
     */
    ProductionRecord(Product newProduct) throws IllegalProductionRecordArgumentException {
     ...
     * @throws IllegalProductArgumentException thrown if illegal parameter.
     */
    ProductionRecord(Product newProduct, String employeeUsername)
            throws IllegalProductionRecordArgumentException {
        setProduct(newProduct);
        setProductID(newProduct.getId());
        setProductionNum(1);
     ...
     * @throws IllegalProductionRecordArgumentException thrown if a parameter is invalid.
     */
    public void setSerialNum() throws IllegalProductionRecordArgumentException {
        int count = 0;
        if (this.product.getType().toString().compareTo(ItemType.Audio.toString()) == 0) {
            count = ++audioCount;
        }
        if (this.product.getType().toString().compareTo(ItemType.Visual.toString()) == 0) {
            count = ++visualCount;
        }
